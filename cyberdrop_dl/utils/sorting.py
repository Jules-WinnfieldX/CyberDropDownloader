...
from cyberdrop_dl.utils.utilities import FILE_FORMATS, purge_dir, log, log_with_color
...
class Sorter:
    ...
    async def sort(self) -> None:
        ...
        await log_with_color(f"Organized: {audio_count} Audio Files", style="green")
        await log_with_color(f"Organized: {image_count} Image Files", style="green")
        await log_with_color(f"Organized: {video_count} Video Files", style="green")
